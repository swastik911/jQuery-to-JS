...
var outsideClick = function (e) {
   ...
   if (!container == (e.target) && container.has(e.target).length === 0 && container.is(':visible')) {
...
var crossStringClick = function (elem) {
   ...
   var parentWithActiveClass = target.parentNode.hasClass(".active");
   if (parentWithActiveClass) {
      parentWithActiveClass.classList.remove("active");
   }
};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   document.querySelector(".custmonDropDwon").addEventListener('click', function (e) {
      if (e.target.hasClass("crossString") || e.target.hasClass("bowiro")) {
         return false;
      }
      ...
      if (e.target.hasClass("language") || e.target.parentElement().hasClass("language")) {
         languageFunc();

      }

      if (window.getComputedStyle().matches('(max-width: 1170px)')) {
         document.body.style.overflow = 'hidden';
      }
      ...
      //    $(this).children(".customDrp").addClass("active");
      // }
      var nextEl = document.querySelector('.custmonDropDwon').nextElementSibling()
      if (nextEl.hasClass('customDrp')) {
         nextEl.classList.add("active");
      } else {
         var childrenEls = document.querySelector('.custmonDropDwon').children();
         childrenEls.forEach(el => {
            if(el.hasClass('.customDrp')) {
   ...
   document.querySelector(".basic_banner_read_btn").addEventListener("click", function () {
      if (basic_banner_read_btn == false) {
         document.querySelector(".basic_banner_read_btn").innerText("Read Less");
         // $(".basic_banner_text").slideToggle(500);
         basic_banner_read_btn = true;
      } else {
         // $(".basic_banner_text").slideToggle(500);
         document.querySelector(".basic_banner_read_btn").innerText("Read More");
         basic_banner_read_btn = false;
      }
   });
         ...
         if (
            ...
            if (target.hasAttribute("data-target")) {
               ...
               if (m_ID == "LoginBox") {
                  ...
                  document.querySelector("#fpass_error").innerHTML("");
               } else if (m_ID == "selectCurrency") {
                  currencyFunc();
               }
            }
   ...
   // ==  responsiveTable currenciesTable == //
   document.querySelector(".currenciesTable, .exchangeTable").addEventListener("scroll", function (e) {
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelector(".ListingTable th:nth-child(2), td:nth-child(2)").classList.add("before");
      } else {
         document.querySelector(".ListingTable th:nth-child(2), td:nth-child(2)").classList.remove("before");
      }
   });
   ...
   document.querySelector(".historical-data").addEventListener("scroll", function (e) {
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelector(".ListingTable th:nth-child(1), td:nth-child(1)").classList.add("before");
      } else {
         document.querySelector(".ListingTable th:nth-child(1), td:nth-child(1)").classList.remove("before");
      }
   });
   ...
   document.addEventListener('DOMContentLoaded', function () {
      window.addEventListener('scroll', function () {
         var scrolled = window.scrollTop();
         if (scrolled > 200) {
            document.querySelector(".gototopIconDiv").style.transition = "1s"
            document.querySelector(".gototopIconDiv").style.opacity = "1"
         }
         if (scrolled < 200) {
            document.querySelector(".gototopIconDiv").style.transition = "1s"
            document.querySelector(".gototopIconDiv").style.opacity = "0"
         }
      })
      ...
      document.querySelector(".gototopIconDiv").addEventListener('click', function () {
         document.querySelectorAll("html, body").forEach(el => {
            ...
            // );
            el.scrollTop = "0",
            el.style.scrollBehaviour = 'smooth'
         })
      });
   })
   ...
   document.querySelector(".popupRemover").addEventListener('click', function () {
   ...
   let isHighLight = document.querySelector("#HighlightsBox");
...
document.querySelector(".faqAcc .flexAccHead").addEventListener("click", function () {
   let AccHeadObj = document.querySelector(".faqAcc .flexAccHead");
   AccHeadObj.parentNode().parentNode().children().children().classList.remove('active');
   AccHeadObj.parents(".faqAcc li").find(".faqDesc").classList.add("active");
});
// == === == faq scripts == == == //
